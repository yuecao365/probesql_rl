#!/usr/bin/env bash
# Evaluate arm 4 at steps 15 and 25 under the frozen protocol.
#
...
for spec in "arm4_s25:ckpt/rl/arm4_0919_0319/global_step_25/actor" \
            "arm4_s15:ckpt/rl/arm4_0919_0319/global_step_15/actor"; do
  ARM=${spec%%:*}; CK=${spec#*:}
